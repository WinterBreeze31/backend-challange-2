    ...
    <div class="w3-container">
        ...
        ?>
            ...
            <div class="w3-card-4" style="width:25%; display:inline-block;">
                ...
                <div class="w3-container">
                    ...
                    foreach ($items as $val1) { ?>
                        <div class="item ">
                            ...
                            <br>
                            <span class="w3-tag w3-orange"><?php if ($val1['status']) { echo "active"; } else { echo "inactive"; } ?></span>
                            ...
                            <div class="w3-modal-content">
                                <div class="w3-container">
                                    ...
                                    <form action="#" method="post" class="w3-container">
                                        ...
                                        <input type="radio" name="itemStatus" value="1" <?php if ($val1['status']) { echo "checked"; } ?>>
                                        <label>Active</label><br>
                                        <input type="radio" name="itemStatus" value="0" <?php if (! $val1['status']) { echo "checked"; } ?>>
                ...
                <button class="w3-button w3-block w3-yellow">Edit List</button>
